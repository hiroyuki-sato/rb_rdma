...
void Init_rb_rdma(){
  IBA = rb_define_module("RbRDMA");
    ...
    rb_const_set(IBA, rb_intern("PKEY_MEMBERSHIP_BIT"), INT2FIX(1<<15));
    rb_const_set(IBA, rb_intern("PKEY_INVALID"), INT2FIX(0));

    // Well known QKEY Constants
    rb_const_set(IBA, rb_intern("IB_DEFAULT_QP0_QKEY"), INT2FIX(0));
    rb_const_set(IBA, rb_intern("IB_DEFAULT_QP1_QKEY"), INT2FIX(0x80010000));
    ...
    // GID Constants
//    rb_const_set(IBA, rb_intern("GID_DEFAULT_PREFIX"), INT2NUM(0xFE80 << 48));
    rb_const_set(IBA, rb_intern("IB_DEFAULT_SUBN_PREFIX"), INT2NUM(IB_DEFAULT_SUBN_PREFIX));
    ...
    rb_const_set(IBA, rb_intern("LINK_SPEED_MAX"),   INT2FIX(0));
    rb_const_set(IBA, rb_intern("LINK_SPEED_2Gb5"),  INT2FIX(2));
    rb_const_set(IBA, rb_intern("LINK_SPEED_5Gb0"),  INT2FIX(5));
    rb_const_set(IBA, rb_intern("LINK_SPEED_10Gb0"), INT2FIX(3));
    rb_const_set(IBA, rb_intern("LINK_SPEED_20Gb0"), INT2FIX(6));
    rb_const_set(IBA, rb_intern("LINK_SPEED_30Gb0"), INT2FIX(4));
    rb_const_set(IBA, rb_intern("LINK_SPEED_40Gb0"), INT2FIX(7));
    rb_const_set(IBA, rb_intern("LINK_SPEED_60Gb0"), INT2FIX(8));
    rb_const_set(IBA, rb_intern("LINK_SPEED_80Gb0"), INT2FIX(9));
    rb_const_set(IBA, rb_intern("LINK_SPEED_120Gb0"),INT2FIX(10));
    rb_const_set(IBA, rb_intern("LINK_SPEED_14Gb0"), INT2FIX(11));
    rb_const_set(IBA, rb_intern("LINK_SPEED_56Gb0"), INT2FIX(12));
    rb_const_set(IBA, rb_intern("LINK_SPEED_112Gb0"),INT2FIX(13));
    rb_const_set(IBA, rb_intern("LINK_SPEED_168Gb0"),INT2FIX(14));
    rb_const_set(IBA, rb_intern("LINK_SPEED_25Gb0"), INT2FIX(15));
    rb_const_set(IBA, rb_intern("LINK_SPEED_100Gb0"),INT2FIX(16));
    rb_const_set(IBA, rb_intern("LINK_SPEED_200Gb0"),INT2FIX(17));
    rb_const_set(IBA, rb_intern("LINK_SPEED_300Gb0"),INT2FIX(18));
#endif
    ...
    // 
    rb_const_set(IBA, rb_intern("MAD_BASE_VERSION"), INT2FIX(UMAD_BASE_VERSION));

    // TODO
    // rb_const_set(IBA, rb_intern("MAD_NOTICE_FATAL"), INT2FIX(0));
    // MAD_NOTICE_FATAL = 0;
    // MAD_NOTICE_URGENT = 1;
    ...
    rb_const_set(IBA, rb_intern("UMAD_SA_STATUS_SUCCESS"), INT2FIX(UMAD_SA_STATUS_SUCCESS));
    rb_const_set(IBA, rb_intern("UMAD_SA_STATUS_NO_RESOURCES"), INT2FIX(UMAD_SA_STATUS_NO_RESOURCES));
    rb_const_set(IBA, rb_intern("UMAD_SA_STATUS_REQ_INVALID"), INT2FIX(UMAD_SA_STATUS_REQ_INVALID));
    rb_const_set(IBA, rb_intern("UMAD_SA_STATUS_NO_RECORDS"), INT2FIX(UMAD_SA_STATUS_NO_RECORDS));
    rb_const_set(IBA, rb_intern("UMAD_SA_STATUS_TOO_MANY_RECORDS"), INT2FIX(UMAD_SA_STATUS_TOO_MANY_RECORDS));
    rb_const_set(IBA, rb_intern("UMAD_SA_STATUS_INVALID_GID"), INT2FIX(UMAD_SA_STATUS_INVALID_GID));
    rb_const_set(IBA, rb_intern("UMAD_SA_STATUS_INSUF_COMPS"), INT2FIX(UMAD_SA_STATUS_INSUF_COMPS));
    rb_const_set(IBA, rb_intern("UMAD_SA_STATUS_REQ_DENIED"), INT2FIX(UMAD_SA_STATUS_REQ_DENIED));
    rb_const_set(IBA, rb_intern("UMAD_SA_STATUS_PRI_SUGGESTED"), INT2FIX(UMAD_SA_STATUS_PRI_SUGGESTED));

    // TODO
    // MAD_STATUS_CLASS_SHIFT = 8;
    // MAD_STATUS_CLASS_MASK = 0x7F;
    rb_const_set(IBA, rb_intern("UMAD_STATUS_CLASS_MASK"), INT2FIX(UMAD_STATUS_CLASS_MASK));
    ...
    // RMPP_FLAGS_ENUM
    rb_const_set(IBA, rb_intern("RMPP_FLAG_ACTIVE"), INT2FIX(IB_RMPP_FLAG_ACTIVE));
    rb_const_set(IBA, rb_intern("RMPP_FLAG_FIRST"), INT2FIX(IB_RMPP_FLAG_FIRST));
    rb_const_set(IBA, rb_intern("RMPP_FLAG_LAST"), INT2FIX(IB_RMPP_FLAG_LAST));
